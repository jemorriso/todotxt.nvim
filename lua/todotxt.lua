...
todotxt.sort_by_current_project = function()
	...
	local current_project = current_line:match("%+([%w%.%-%_]+)")
	...
	sort_tasks_by(function(a, b)
		local a_has_project = a:match("%+" .. current_project .. "[^%w%.%-%_]") or a:match("%+" .. current_project .. "$")
		local b_has_project = b:match("%+" .. current_project .. "[^%w%.%-%_]") or b:match("%+" .. current_project .. "$")
